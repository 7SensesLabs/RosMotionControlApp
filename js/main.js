...
// These lines create a topic object as defined by roslibjs
    ...
    poseTopic.subscribe(function(data){
        $('table tr').eq(0).find('td').eq(1).html(data.x);
        $('table tr').eq(1).find('td').eq(1).html(data.y);
        $('table tr').eq(2).find('td').eq(1).html(data.linear_velocity);
        $('table tr').eq(3).find('td').eq(1).html(data.angular_velocity);
        $('table tr').eq(4).find('td').eq(1).html(data.theta);
    })
}
